...
import { FaWhatsapp, FaTelegramPlane, FaInstagram, FaEnvelope, FaHeadset, FaDownload, FaTrash } from "react-icons/fa"
...
const handleDeleteFile = async (file) => {
  ...
  try {
    // Delete the individual file from the alias
    const encodedFileName = encodeURIComponent(file.name);
    await axiosInstance.delete(`/alias/${file.alias}/file/${encodedFileName}`);
