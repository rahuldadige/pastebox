...
// updateUser
export const updateUser = createAsyncThunk('auth/updateUser', async ({ userId, username, profilePic }, { rejectWithValue }) => {
  try {
    ...
    const res = await axiosInstance.put(`/users/user/${userId}`, formData, {
      headers: {
